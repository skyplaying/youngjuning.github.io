...
Strings are a collection of bytes in Go. It's alright if this definition doesn't make any sense. For now, we can assume a string to be a collection of characters.
